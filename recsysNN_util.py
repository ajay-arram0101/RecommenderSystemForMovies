...
def load_data():
    ...
    item_train = genfromtxt('data/item_training_set.csv', delimiter=',')
    user_train = genfromtxt('data/user_training_set.csv', delimiter=',')
    y_train    = genfromtxt('data/y_training_set.csv', delimiter=',')
    ...
    item_vecs = genfromtxt('data/item_vectors_data.csv', delimiter=',')
...
#    with open('./data/movies.csv', newline='') as csvfile:
    ...
    with open('data/user_to_genre_file.pickle', 'rb') as f:
